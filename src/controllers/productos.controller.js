...
    try {
      // CAMBIO AQUÍ: Ordenar por fecha de creación descendente
      let query = `SELECT ${selectedFields} FROM producto ORDER BY fecha_creacion DESC`;
...
  
  // CAMBIO AQUÍ: Ordenar por fecha de creación descendente
  const finalQuery = query + " ORDER BY fecha_creacion DESC" + processLimit(maxResults);
